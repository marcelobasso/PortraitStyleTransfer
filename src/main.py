...
if __name__ == '__main__':
    if len(sys.argv) < 6:
        ...
        print("Usage: python3 main.py <input_image> <example_image> <gray> <use_mask> <output_image>")
        print("Example: python3 main.py carlos george false true output_image")
        sys.exit(1)
    else:
        ...
        st = StyleTransfer(input_img, example_img, gray_op, use_mask, output_img)
        st.run()
